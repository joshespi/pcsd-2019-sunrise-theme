			...
			<h1>Sunrise Preschool</h1>
				...
				<aside>
					<ul class="sociallinks">
						<li><a href="https://www.instagram.com/sunrise_preschool_provo/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
							</a>
						</li>
